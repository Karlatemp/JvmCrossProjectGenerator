package io.github.karlatemp.jcpg.templates;
...
class NativeLibLoader {
    private static final String LIB_LOC = "[[${settings.nativeResourceLocation}]]";
    private static final String LIB_NAME = "[[${settings.nativeLibName}]]";
    private static final String LOCAL_LIB_PATH_PREFIX = "[[${settings.nativePath}]]/cmake-build-debug/lib" + LIB_NAME + ".";
    private static final String PROJECT_NAME = "[[${settings.projectName}]]";
